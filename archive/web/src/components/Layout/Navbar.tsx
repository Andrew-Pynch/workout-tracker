...
const NavLinks = [
  { title: "Add", href: "/", target: "_self" },
  { title: "View", href: "/view", target: "_self" },
];
  ...
  return (
    <>
      <nav
        ref={navbarRef}
        className={`
          bg-primary font-ibm-plex-mono fixed z-[100] flex h-max w-full 
          justify-center bg-opacity-60 px-4 py-6 backdrop-blur-md
      ...
      >
        ...
        <div className="flex w-full items-center justify-between">
          <div className="flex">{/* <Logo asLink /> */}</div>

          {/* Hamburger Menu Icon */}
          <Hamburger
            onClick={handleMobileMenuToggle}
            className="text-secondary cursor-pointer select-none text-4xl lg:hidden"
          />
          ...
          <AnimatePresence>
            {isMobileMenuOpen && (
              <motion.div
                ...
                className={`
                  bg-primary
                  font-ibm-plex-mono absolute right-0 top-0 z-[201] flex 
                  h-screen w-64 flex-col gap-4
                  px-4
